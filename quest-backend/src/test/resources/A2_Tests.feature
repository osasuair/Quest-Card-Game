Feature: Quest Game
  ...
  Scenario: A1_scenario
    ...
    And Players '[P4]' should have 4 shields
    And Players '[P1, P2, P3]' should have 0 shields
  ...
  Scenario: 2winner_game_2winner_quest
    ...
    And Players build their stage 3 attack
      ...
      | P4     | [L20]  |
    And Players attack the stage 3
    And P3's quest is cleaned up
      | player | discard  |
      | P3     | first[3] |
    And Players '[P2, P4]' should 'earn' 3 shields
    And Players '[P2, P4]' should have 7 shields
  ...
  Scenario: 1winner_game_with_events
    ...
    And Players '[P2]' should have 5 shields
    And Players '[P3]' should have 7 shields
    And Players '[P4]' should have 4 shields
  ...
  Scenario: 0_winner_quest
    ...
    And Players '[P1, P2, P3, P4]' should have 0 shields
    And P1 should discard and draw 6 cards
    And Player P1 should have 12 cards
    And Player P2 should have 12 cards
    And Player P3 should have 12 cards
    And Player P4 should have 12 cards
